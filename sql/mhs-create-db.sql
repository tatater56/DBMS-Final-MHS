...
CREATE DATABASE IF NOT EXISTS `mhs` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `mhs`;
...
CREATE TABLE IF NOT EXISTS `doctortreatspatient` (
...
CREATE TABLE IF NOT EXISTS `makesappointment` (
  `Doctor_ID` int(11) NOT NULL,
  `P_id` int(11) NOT NULL,
